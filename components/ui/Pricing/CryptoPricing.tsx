            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                        PolyGlot Intelligence Engine
                    </h2>
                    <p className="mt-6 text-lg leading-8 text-gray-300">
                        Unlock the power of global news and prediction markets.
                        <br />
                        <span className="text-indigo-400 font-semibold">Currently in Free Beta</span>
                    </p>
                </div>
                <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-700 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        <h3 className="text-2xl font-bold tracking-tight text-white">Full Access</h3>
                        <p className="mt-6 text-base leading-7 text-gray-300">
                            Get full access to all features including GDELT news analysis, Polymarket signals, and Gemini-powered insights during our beta period.
                        </p>
                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div className="rounded-2xl bg-gray-900 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                            <div className="mx-auto max-w-xs px-8">
                                <p className="text-base font-semibold text-gray-400">Beta Status</p>
